...
const index_ts_1 = require("../../shared/src/lib/database/index/index.ts");
...
async function startTestMongo() {
    ...
    await (0, index_ts_1.disconnectDB)();
    (0, index_ts_1.resetDBConnectionState)();
    await (0, index_ts_1.connectDB)();
    return uri;
}
