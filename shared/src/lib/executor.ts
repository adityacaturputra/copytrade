        ...
        for (const {
          ...
          try {
            ...
            if (signal.action === "CANCEL" && signal.symbol) {
              ...
              // Do not continue! Let it fall through so a Draft is created for the CANCEL action itself.
              // In auto mode, the standard executeSignal flow handles cancelling positions.
            }
